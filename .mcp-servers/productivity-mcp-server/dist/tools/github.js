import { GitHubListReposSchema, GitHubGetRepoSchema, GitHubListIssuesSchema, GitHubGetIssueSchema, GitHubCreateIssueSchema, GitHubUpdateIssueSchema, GitHubAddIssueCommentSchema, GitHubListPRsSchema, GitHubGetPRSchema, GitHubCreatePRSchema, GitHubAddPRReviewSchema } from "../schemas/github.js";
import { listRepos, getRepo, listIssues, getIssue, getIssueComments, createIssue, updateIssue, addIssueComment, listPRs, getPR, getPRReviews, createPR, addPRReview } from "../services/github.js";
...
Returns:
  Update confirmation.`,
    ...
    // Add Issue Comment
    server.registerTool("github_add_issue_comment", {
...
Returns:
  Created comment URL.`,
        ...
        try {
            const comment = await addIssueComment(params.owner, params.repo, params.issue_number, params.body);
            return {
                content: [{
                        type: "text",
...
Returns:
  Created PR number and URL.`,
    ...
    // Add PR Review
    server.registerTool("github_add_pr_review", {
        title: "Add PR Review",
