...
import {
  ...
  DiscordSendEmbedSchema,
  DiscordDeleteMessageSchema,
  DiscordSendMessageInput,
  DiscordSendEmbedInput,
  DiscordDeleteMessageInput
...
Returns:
  Message ID (can be used to delete the message later).`,
    ...
    async (params: DiscordSendMessageInput) => {
      try {
...
Returns:
  Message ID.`,
    ...
    async (params: DiscordSendEmbedInput) => {
      try {
...
Returns:
  Deletion confirmation.`,
    ...
    async (params: DiscordDeleteMessageInput) => {
      try {
